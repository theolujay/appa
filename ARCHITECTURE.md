...
**Orchestration Scope**
Appa currently uses standard **Docker Compose** for its simplicity and reliability on single-node setups. While **Docker Swarm** or **Kubernetes** offer better horizontal scaling, they introduce significant complexity that contradicts Appa's goal of "single-command installation" for small to medium teams.
